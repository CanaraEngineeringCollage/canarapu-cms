...
async function GET(req) {
    try {
        ...
        const events = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.findMany({
            where: category ? {
                category
            } : undefined,
            orderBy: {
...
async function PUT(req) {
    ...
    try {
        ...
        const event = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.upsert({
            where: {
                category
            },
            update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31e5d0a1._.js.map
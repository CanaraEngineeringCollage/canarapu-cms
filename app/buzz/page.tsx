...
const BuzzPage = () => {
  ...
  const filteredItems = buzzItems
    ...
    .filter((item) => (searchTerm.trim() ? item.name?.toLowerCase().includes(searchTerm.toLowerCase()) : true));
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input placeholder="Search buzz..." className="pl-8" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
        </div>
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr className="text-center">
                      ...
                      <td className="border p-2 align-top">{item.date ? new Date(item.date).toLocaleDateString("en-GB") : "N/A"}</td>
                    </tr>
                  </tbody>
                </table>
